...
public interface IRNG {
	...
	/**
	 * Vraća decimalni broj iz intervala [min,max) prema uniformnoj
	 * distribuciji.
	 *
	 * @param min
	 *            donja granica intervala (uključiva)
	 * @param max
	 *            gornja granica intervala (isključiva)
	 *
	 * @return slučajno generirani decimalni broj
	 */
	...
	/**
	 * Vraća cijeli broj iz intervala svih mogućih cijelih brojeva prema
	...
	/**
	 * Vraća slučajno generiranu boolean vrijednost. Vrijednosti se izvlače iz
